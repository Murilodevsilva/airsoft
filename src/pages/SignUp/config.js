...
export const Complete = () => {
  ...
  return (
    <View style={{ backgroundColor: '#18191A', height: '100%' }}>
      <View>
        <Text
          style={{ fontSize: 21, color: '#FFF', fontWeight: 700, marginTop: 70, marginLeft: 16 }}
        >
          Dados do usuário
        </Text>
        <Text
        ...
        >
          Essas informações são visíveis para os organizadores de eventos que você participar e
          administradores da sua equipe.
        </Text>
      </View>
      <View>
        <Text
      ...
      >
        <Text style={{ color: '#FFF', textAlign: 'center' }}>Nome completo</Text>
      </View>
      <View
        style={{
          alignSelf: 'center',
      ...
      >
        ...
        <View style={{ backgroundColor: '#18191A', width: 80, top: -45 }}>
          <Text style={{ color: '#FFF', textAlign: 'center' }}>Localização</Text>
        </View>
      </View>
      <View
        style={{
      ...
      >
        <Text style={{ color: '#FFF', textAlign: 'center' }}>Classe de combate</Text>
      </View>
      ...
      <View style={{ position: 'absolute', bottom: 111, right: 60 }}>
        <Patent />
      </View>
      <TouchableOpacity
