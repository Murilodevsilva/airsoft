...
return(
    <View style={{backgroundColor:'#000',flex:1,width:'100%',paddingTop:100,alignItems:'flex-start',paddingLeft:40}}>
        ...
        <View style={{top:30,left:25,backgroundColor:'black',width:140,height:20,zIndex:1}}>
...
<TouchableOpacity onPress={()=>navigation.navigate('Complete')} style={{width:345,height:51,backgroundColor:'#2374E1',justifyContent:'center',borderRadius:9}}>
    <Text style={{color:'#FFF',fontSize:18,textAlign:'center',marginBottom:5}}>Confirmar</Text>
</TouchableOpacity>
<TouchableOpacity onPress={()=>navigation.navigate ('SignUp')} style={{width:345,height:51,borderWidth:1,borderColor:'#2374E1',justifyContent:'center',borderRadius:9,marginTop:20}}>
    <Text style={{color:'#2374E1',fontSize:18,textAlign:'center',marginBottom:5}}>Reenviar código</Text>
</TouchableOpacity>
